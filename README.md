...
| [`src/m3gast3gg/field_guide.md`](src/m3gast3gg/field_guide.md) | Analyst persona, technique catalog, signal-reading heuristics, transport-survival tables | An agent about to analyze a file, fetched on-demand via the `stegg://field-guide` MCP resource |
